...
let sub = '';// 留空则使用内置订阅
let subconverter = 'psub.libuluke002.workers.dev';// clash订阅转换后端，目前使用CM的订阅转换功能。自带虚假uuid和host订阅。
let subconfig = "https://raw.githubusercontent.com/ruanxue6688/ClashConfig/main/CM.ini"; //订阅配置文件
